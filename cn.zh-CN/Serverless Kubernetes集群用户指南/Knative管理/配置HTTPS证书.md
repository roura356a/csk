...
Gateway的详细介绍请参见[Knative Gateway](/cn.zh-CN/Serverless Kubernetes集群用户指南/Knative管理/Knative Gateway.md)。
...
您可以通过使用阿里云签发的证书或上传非阿里云签发的证书的方式创建证书，详细介绍请参见[选择阿里云签发证书](/cn.zh-CN/用户指南/证书管理/创建证书/选择阿里云签发证书.md)和[上传非阿里云签发证书](/cn.zh-CN/用户指南/证书管理/创建证书/上传非阿里云签发证书.md)。
...
**说明：** 更多域名管理操作请参见[添加扩展域名](/cn.zh-CN/用户指南/监听/扩展域名/添加扩展域名.md)。
