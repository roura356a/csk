...
阿里云Serverless Kubernetes集群，基于[基于域名或URL路径进行转发](/cn.zh-CN/CLB教程专区/基于域名或URL路径进行转发.md)提供了托管的SLB Ingress Controller ，您无需承担额外的IaaS成本，云产品级别的容灾能力给您提供稳定的Ingress服务。
...
[通过Ingress提供7层服务访问](/cn.zh-CN/Serverless Kubernetes集群用户指南/网络管理/通过Ingress提供7层服务访问.md)

[Nginx Ingress概述](/cn.zh-CN/Serverless Kubernetes集群用户指南/网络管理/Nginx Ingress管理/Nginx Ingress概述.md)
