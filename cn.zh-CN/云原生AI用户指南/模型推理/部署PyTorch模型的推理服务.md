...
-   已创建包含GPU的Kubernetes集群。具体操作，请参见[创建包含GPU的Kubernetes集群](/cn.zh-CN/Kubernetes集群用户指南/GPU/NPU/GPU调度/使用Kubernetes默认GPU调度.md)。
-   Kubernetes集群可以访问公网。具体操作，请参见[集群节点可以访问公网](/cn.zh-CN/Kubernetes集群用户指南/集群/连接集群/集群访问控制/控制集群API Server的公网访问能力.md)。
...
1.  完成PyTorch单机训练，且把PyTorch模型转换成Torchscript，具体操作，请参见[PyTorch单机训练](/cn.zh-CN/云原生AI用户指南/模型训练/PyTorch单机训练.md)。
...
3.  将准备好的模型上传到OSS上。具体操作，请参见[上传文件](/cn.zh-CN/快速入门/控制台快速入门/上传文件.md)。
...
8.  配置公网Ingress。具体操作，请参见[创建Ingress路由](/cn.zh-CN/Kubernetes集群用户指南/网络/Ingress管理/创建Ingress路由.md)。
