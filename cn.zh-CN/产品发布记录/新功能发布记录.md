...
|集群连接支持生成短时kubeconfig|集群访问所需的kubeconfig信息，现已支持短时签发，时间跨度从3天到30分钟，满足您临时授权管理K8s集群的需求。|全部|[t16645.md\#](/cn.zh-CN/Kubernetes集群用户指南/集群/连接集群/通过kubectl管理Kubernetes集群.md)|
...
|全部|[通过集群检查功能定位集群问题](/cn.zh-CN/最佳实践/运维/通过集群检查功能定位集群问题.md)|
...
|智能运维集群检查功能|集群检查可以深度检查集群资源、组件、配置等，快速定位集群使用问题。|中国内地（大陆）|[t159904.md\#](/cn.zh-CN/最佳实践/运维/通过集群检查功能定位集群问题.md)|
...
|集群智能运维新增开通地域|智能运维的目的是提供不同场景下的容器集群使用的最优解决方案，您可以进行深度检查集群资源、组件、配置等信息，帮助您快速定位集群使用问题。|华东1（杭州）|[通过集群检查功能定位集群问题](/cn.zh-CN/最佳实践/运维/通过集群检查功能定位集群问题.md)|
