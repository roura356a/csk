...
|支持AMD CPU拓扑调度|resource-controller组件发布最新版v1.2.1-d1e280f-aliyun，结合ACK K8s 1.20.4版本的调度器ack-scheduler，支持了AMD CPU的拓扑调度。|全部|[CPU拓扑感知调度](/cn.zh-CN/Kubernetes集群用户指南/调度/CPU拓扑感知调度/CPU拓扑感知调度.md)|
