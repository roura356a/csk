...
|addons|Array of [addon](/cn.zh-CN/API参考/通用数据结构.md)|否| |集群组件列表，创建集群时通过`addons`指定想要安装的集群组件。
...
|master\_instance\_types|Array of String|是|ecs.n4.xlarge|Master节点实例类型。关于ECS实例规格的具体介绍，请参见[实例规格族](/cn.zh-CN/实例/实例规格族.md)。 |
...
|worker\_instance\_types|Array of String|是|ecs.n4.large|Worker节点实例规格，至少要指定一个实例规格。更多信息，请参见[t9548.dita\#concept\_sx4\_lxv\_tdb](/cn.zh-CN/实例/实例规格族.md)。
