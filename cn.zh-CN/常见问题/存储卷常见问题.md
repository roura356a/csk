...
如果没有安装，请参考[安装插件](../../../../cn.zh-CN/用户指南/Kubernetes集群/存储管理/安装插件.md#)。
...
如果节点为手动添加，可能是由于sts权限的问题导致，需要手动配置RAM权限：[../../../../dita-oss-bucket/SP\_2/DNA0011894323/ZH-CN\_TP\_9665.md\#](../../../../cn.zh-CN/安全/实例RAM角色/通过控制台使用实例RAM角色.md#)。
...
可以通过配置健康检查实现容器或Pod的自动重启，请参考[使用阿里云 OSS](../../../../cn.zh-CN/用户指南/Kubernetes集群/存储管理/使用阿里云 OSS.md#)。
