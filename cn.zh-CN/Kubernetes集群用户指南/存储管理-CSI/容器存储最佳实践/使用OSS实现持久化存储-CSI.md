...
-   已创建ACK集群。具体操作，请参见[创建Kubernetes托管版集群](/cn.zh-CN/Kubernetes集群用户指南/集群管理/创建集群/创建Kubernetes托管版集群.md)。
...
1.  使用以下内容，创建oss-static.yaml。
    ...
    -   `livenessProbe`：配置健康检查，详细介绍，请参见[OSS卷使用说明](/cn.zh-CN/Kubernetes集群用户指南/存储管理-CSI/OSS存储卷/OSS卷使用说明.md)。
