...
1.  RAM Policy设置和授予。
    ...
    -   编辑Kubernetes集群的Master RAM角色中的自定义策略内容，添加以上NAS相关的权限设置。请参见[角色授权](/cn.zh-CN/Kubernetes集群用户指南/授权管理/角色授权.md)。
    ...
    -   创建子账号授权以上RAM Policy并生成AccessKey，配置到StatefulSet csi-provisioner中csi-nasprovisioner的env变量中。请参见[角色授权](/cn.zh-CN/Kubernetes集群用户指南/授权管理/角色授权.md)。
