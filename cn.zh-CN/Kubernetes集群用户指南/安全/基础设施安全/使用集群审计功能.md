...
-   审计中心概览
    ...
    **说明：** 在该报表中，默认显示一周的统计信息。您可以自定义选择统计时间范围。此外，该报表支持指定Namespace、子账号ID、状态码进行筛选。您可以选择任意一项或多项组合筛选指定范围的事件。
...
-   资源操作详细列表
    ...
    **说明：**
    ...
    -   在该报表中，默认显示一周的统计信息。您可以自定义选择统计时间范围。此外，该报表支持指定Namespace、子账号ID、状态码进行筛选。您可以选择任意一项或多项组合筛选指定范围的事件。
