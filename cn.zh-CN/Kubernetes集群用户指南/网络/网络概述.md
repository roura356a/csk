...
![示例](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2777591361/p328067.png)
...
-   -   **VPC**
    ...
    -   私网网段
        ...
        您可以使用下表中标准的私网网段及其子网作为VPC的私网网段，也可以使用自定义地址段作为VPC的私网网段。更多信息，请参见[网络规划](/cn.zh-CN/快速入门/网络规划.md)。
