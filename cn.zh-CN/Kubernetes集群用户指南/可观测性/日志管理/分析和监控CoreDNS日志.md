...
1.  在目标图表卡片右上方，选择**![more](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/4484619161/p267496.png)** \> **另存为告警 \(旧版\)**。关于告警配置的参数设置，请参见[设置告警](/cn.zh-CN/告警/告警（旧版）/设置告警.md)。
