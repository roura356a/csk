...
3.  选择所需的集群并单击操作列的**更多** \> **自动伸缩**。 
    ...
    ![自动伸缩](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/19071/156887869811191_zh-CN.png)
...
1.  开通ESS服务 
    1.  单击弹出对话框中的第一个链接，进入**弹性伸缩服务 ESS**页面。 
        ...
        ![开通ESS服务](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/19071/156887869811211_zh-CN.png)

    2.  单击**开通ESS服务**，进入云产品开通页。 

        ![云产品开通](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/19071/156887869811263_zh-CN.png)

    3.  选中**我已阅读并同意**复选框，单击**立即开通**。 

        ![立即开通](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/19071/156887869811264_zh-CN.png)

    4.  开通成功后，在开通完成页签，单击**管理控制台**，进入弹性伸缩服务 ESS页面。 

        ![弹性ESS](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/19071/156887869811265_zh-CN.png)

    5.  单击**前往授权**，进入云资源访问授权页面，配置对云资源的访问权限。 

        ![云资源访问授权](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/19071/156887869811266_zh-CN.png)

    6.  单击**同意授权**。 

        ![同意授权](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/19071/156887869811267_zh-CN.png)
...
1.  单击弹出对话框中的第二个链接，进入**RAM角色管理**详情页面。 
    ...
    **说明：** 此处需要以主账号登录控制台。
    ...
    ![RAM角色管理](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/19071/156887869811261_zh-CN.png)

2.  在**权限管理**页签，单击目标授权策略名称，进入授权策略详情页面。 

    ![权限管理](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/19071/156887869811193_zh-CN.png)

3.  单击**修改策略内容**，从右侧滑出侧边栏修改策略内容页面。 

    ![修改策略内容](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/19071/156887869911195_zh-CN.png)
...
2.  根据所需要弹性伸缩的资源类型（普通/GPU/抢占式），单击操作列**创建**。 
    ...
    ![创建资源类型](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/19071/156887869911210_zh-CN.png)
...
1.  在自动伸缩页面，可以在普通实例下看到新创建的一个伸缩组。 
    ...
    ![自动伸缩](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/19071/156887869911273_zh-CN.png)

2.  在 Kubernetes 菜单下，单击左侧导航栏中的**应用** \> **无状态**，进入无状态（Deployment）页面。
3.  选择目标集群和kube-system命名空间，可以看到名称为cluster-autoscaler的组件，表示伸缩组已创建成功。 

    ![创建伸缩组](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/19071/156887869911276_zh-CN.png)
