...
2.  授权角色。
    ...
    3.  单击**修改策略内容**，从右侧滑出侧边栏修改策略内容页面。
        ...
        ![](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/8734409951/p11195.png)
...
[通过公网访问集群API Server](/cn.zh-CN/Kubernetes集群用户指南/集群管理/连接集群/通过公网访问集群API Server.md)
