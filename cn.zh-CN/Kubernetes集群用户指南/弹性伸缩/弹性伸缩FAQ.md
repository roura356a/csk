...
|类型|问题|
|--|--|
|HPA常见问题|-   [HPA的监控数据current字段为何显示为unknown？](#section_7l1_a7b_adu)
...
|基于组件指标的水平伸缩常见问题|-   [为什么节点自动伸缩组件无法弹出节点？](#section_lcs_33o_9tp)
-   [为什么节点自动伸缩组件无法缩容节点？](#section_lcs_33o_9tp)
-   [多个伸缩组在弹性伸缩的时候是如何被选择的？](#section_lcs_33o_9tp) |
|节点自动伸缩常见问题|-   [如果执行kubectl get hpa后发现target一栏为<unknow\>怎么办？](#section_lcs_33o_9tp)
-   [如何查找HPA支持的指标名称？](#section_lcs_33o_9tp) |
