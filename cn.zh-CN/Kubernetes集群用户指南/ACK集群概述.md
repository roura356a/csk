...
|收费方式|按照集群数量方式收费。更多信息，请参见[产品计费](/cn.zh-CN/.md)。|集群管理免费，但需要承担Worker节点以及其他基础资源的费用。更多信息，请参见[产品计费](/cn.zh-CN/.md)。|集群管理免费，但需要承担Master节点、Worker节点以及其他基础资源的费用。更多信息，请参见[产品计费](/cn.zh-CN/.md)。|
