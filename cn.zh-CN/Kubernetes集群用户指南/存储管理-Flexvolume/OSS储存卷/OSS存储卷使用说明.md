...
-   [直接使用volumes挂载的方式](/cn.zh-CN/Kubernetes集群用户指南/存储管理-Flexvolume/OSS储存卷/使用OSS静态卷.md)
-   [使用创建PV和PVC的方式](/cn.zh-CN/Kubernetes集群用户指南/存储管理-Flexvolume/OSS储存卷/使用OSS静态卷.md)
