...
-   [创建Knative服务](/cn.zh-CN/Kubernetes集群用户指南/Knative管理/Knative服务管理/创建服务.md)
...
6.  在创建修订版本页面，配置参数。
    ...
    1.  设置**基本信息**。
        ...
        有关创建修订版本的基本信息配置，请参见[设置配置信息](/cn.zh-CN/Kubernetes集群用户指南/Knative管理/Knative服务管理/创建服务.mdstep_mrk_8ar_bk6)。
