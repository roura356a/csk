...
3.  选择所需的集群和命名空间，选择所需的路由，然后单击路由右侧的**详情**。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16683/153554704310802_zh-CN.png)

    进入路由详情页面，您可查看该路由的基本信息以及路由规则。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16683/153554704310803_zh-CN.png)
