...
3.  选择所需的集群和命名空间，选择所需的路由，然后单击路由右侧的**删除**。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16685/154821730010804_zh-CN.png)

4.  在弹出的对话框中，单击**确定**，完成删除。 

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16685/154821730010805_zh-CN.png)
