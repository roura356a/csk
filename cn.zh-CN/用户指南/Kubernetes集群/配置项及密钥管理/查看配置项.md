...
3.  选择所需的集群和命名空间，选择所需的配置项，并单击右侧的**详情**。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/136652/156035321540651_zh-CN.png)

4.  进入配置项的详情页面，您可查看该配置项的基本信息，以及配置项包含的数据信息。 

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/136652/156035321640653_zh-CN.png)
