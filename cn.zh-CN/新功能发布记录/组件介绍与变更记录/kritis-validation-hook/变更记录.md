...
|版本号|镜像地址|变更时间|变更内容|
|---|----|----|----|
|v0.2.7.2-g5fa671a-aliyun|registry.cn-hangzhou.aliyuncs.com/acs/kritis-server:v0.2.7.2-g5fa671a-aliyun|2020年11月24日|新功能：支持镜像验签白名单功能，验签时不会对白名单内的镜像进行签名验证。具体配置，请参见[配置镜像验签白名单](/cn.zh-CN/新功能发布记录/组件介绍与变更记录/kritis-validation-hook/组件介绍.md)。|
...
[kritis-validation-hook组件介绍](/cn.zh-CN/新功能发布记录/组件介绍与变更记录/kritis-validation-hook/组件介绍.md)
