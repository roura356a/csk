# 容器服务关于2021年2月23日阿里云ECS管控API异常问题的公告
...
**说明：** 以上脚本是对于网络通信异常的Pod节点进行网络插件重加载操作，运行完成之后，您可以再次运行检查流程中检查脚本，以确认集群是否加固完成。如仍出现异常字样，请[提交工单](https://selfservice.console.aliyun.com/ticket/createIndex)。
