# 更新Kubernetes集群证书 {#concept_jnx_v3b_rfb .concept}
...
## 更新master节点证书 {#section_pdw_cjb_rfb .section}
...
2.  获取集群master节点个数和hostname：
    -   方法一：
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41643/154115359421548_zh-CN.png)
    ...
    -   方法二：
        ...
        2.  在Kubernetes菜单下，单击左侧导航栏的**集群**，进入集群列表页面。
            ...
            ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41643/154115359421549_zh-CN.png)

        3.  选择目标集群，点击集群名称，查看集群详细信息，点击左侧导航栏的**节点列表**获取master个数和hostname。

            ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41643/154115359421550_zh-CN.png)
...
6.  重复执行步骤3~5，完成所有master节点的证书更新。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41643/154115359421551_zh-CN.png)


## 更新worker节点证书 {#section_k4z_skb_rfb .section}
...
1.  任意路径下，复制以下内容，创建job-node.yml文件。
    ...
    **说明：** 如果worker节点带有taint，需要在job-node.yml文件中增加对该taint的`tolerations`，即在`securityContext: {}`与`volumes:`之间增加以下内容（若有n个带有taint的worker节点，请复制n次以下内容）：
    ...
    2.  执行以下命令，查询带有taint的worker节点的$\{name\}和$\{value\}。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41643/154115359421570_zh-CN.png)
...
5.  执行以下命令查看Job状态，当SUCCESSFUL均为1时，证书完成更新。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41643/154115359421565_zh-CN.png)
