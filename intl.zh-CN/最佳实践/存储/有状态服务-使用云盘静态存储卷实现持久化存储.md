...
-   [创建云盘](/intl.zh-CN/块存储/云盘/创建云盘/创建按量付费云盘.md)
...
2.  执行以下命令，创建PV。
    ...
    **验证结果**
    ...
    5.  单击**存储卷**页签，可以看到刚刚创建的PV。
        ...
        ![创建PV](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/3123319951/p158148.png)
...
2.  执行以下命令，创建PVC。
    ...
    **验证结果**
    ...
    5.  单击**存储声明**页签，可以看到刚刚创建的PVC。
        ...
        ![创建PVC](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/4123319951/p158149.png)
...
2.  执行以下命令，创建静态应用。
    ...
    **验证结果**
    ...
    5.  单击**无状态**页签，可以看到刚刚创建的静态应用。
        ...
        ![创建应用](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/4123319951/p158151.png)
