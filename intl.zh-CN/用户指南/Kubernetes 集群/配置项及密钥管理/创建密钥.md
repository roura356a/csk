...
3.  选择所需的集群和命名空间，单击右上角的**创建**。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16704/153553525210766_zh-CN.png)

4.  配置新的保密字典。 

    **说明：** 若您输入密钥的明文数据，请注意勾选**对数据值进行base64编码**

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16704/153553525210767_zh-CN.png)
...
5.  默认返回保密字典页面，您可看到新建的密钥出现在列表中。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16704/153553525210768_zh-CN.png)
