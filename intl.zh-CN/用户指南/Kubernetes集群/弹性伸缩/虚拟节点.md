...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/218258/155805585047141_zh-CN.png)
...
2.  登录 。
3.  在Kubernetes 菜单下，单击左侧导航栏中的**市场** \> **应用目录**，在右侧选中**ack-virtual-node**。
4.  在应用目录-ack-virtual-node页面，单击**参数**，配置虚拟节点参数。
...
5.  配置完成后，在右侧的创建页面，选择对应的集群，可以看到命名空间已设定为kube-system，发布名称已设定为ack-virtual-node，单击**创建**。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/218258/155805585047256_zh-CN.png)

6.  安装完成后，你可以通过**集群** \> **节点**，在节点列表页面可以看到添加了一个节点virtual-kubelet。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/218258/155805585047272_zh-CN.png)
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/218258/155805585047274_zh-CN.png)
...
-   通过设置nodeSelector和tolerations来创建Pod。
    ...
    2.  在 Kubernetes 菜单下，单击左侧导航栏中的**应用** \> **无状态**，单击右上角的**使用模板创建**。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/218258/155805585147286_zh-CN.png)
...
-   通过配置namespace标签的方式创建Pod。
    ...
    2.  执行如下命令，创建Pod。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/218258/155805585147288_zh-CN.png)


选择**应用** \> **容器组**中，当出现如下界面时，表示Pod部署完成。

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/218258/155805585147290_zh-CN.png)
