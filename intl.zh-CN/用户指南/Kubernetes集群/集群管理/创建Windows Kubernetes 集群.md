...
4.  进入创建 Kubernetes 集群页面，填写集群的名称。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/149635/155470630141558_zh-CN.png)

5.  选择集群所在的地域和可用区。 

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/40726/155470630121258_zh-CN.png)
...
6.  设置集群的网络。 
    ...
    **专有网络**：您可以选择**自动创建**（创建 Kubernetes 集群时，同步创建一个 VPC）或者**使用已有**（使用一个已有的 VPC）。选择**使用已有**后，您可以在已有 VPC 列表中选择所需的 VPC 和交换机。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/149635/155470630241560_zh-CN.png)

7.  设置节点类型。 

    **说明：** 支持创建**按量付费**和**包年包月**两种节点类型。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/40726/155470630221260_zh-CN.png)
...
8.  设置实例。 
    ...
    **说明：** 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/149635/155470630241565_zh-CN.png)

9.   显示当前支持的Docker版本和Kubernetes版本，您可查看对应版本，并根据需要进行选择。![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/149635/155470630241572_zh-CN.png)

 
10. 选择操作系统。 操作系统类型选择**Windows**。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/149635/155470630241602_zh-CN.png)

11. 设置登录方式。 设置密码。

    -   **登录密码**：设置节点的登录密码。
    -   **确认密码**：确认设置的节点登录密码。
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/149635/155470630241573_zh-CN.png)
...
12. 设置**Pod 网络 CIDR** 和**Service CIDR** 
    ...
    **说明：** 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/40726/155470630221265_zh-CN.png)
...
13. 设置是否为专有网络配置 SNAT 网关。 
    ...
    **说明：** 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/40726/155470630221267_zh-CN.png)
...
14. 设置公网访问。 API Server提供了各类资源对象（Pod，Service等）的增删改查及watch等HTTP Rest接口。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/149635/155470630241575_zh-CN.png)
...
15. 设置日志服务。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/149635/155470630241574_zh-CN.png)
...
16. 设置RDS白名单。 
    ...
    **说明：** 该选项仅在设置专有网络选择**使用已有**VPC时出现。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/40726/155470630221270_zh-CN.png)

17. 是否启用高级选项。 
    1.  设置节点 Pod 数量，是指单个节点可运行 Pod 数量的上限，建议保持默认值。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16639/15547063029045_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/149635/155470630241598_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/149635/155470630341600_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/149635/155470630341601_zh-CN.png)
