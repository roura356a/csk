...
-   **【商用】网络插件Terway上线** 
    ...
    阿里云容器服务推出高性能网络插件Terway，支持容器直接通过ENI通信，性能比VPC Flannel更高。详细请参见[Terway网络插件](../../../../intl.zh-CN/用户指南/Kubernetes集群/网络管理/Terway网络插件.md#)。
...
-   **【新功能】容器服务Kubernetes 网络功能增强，支持Network Policy和带宽限制** 
    ...
    详细请参见[通过负载均衡（Server Load Balancer）访问服务](../../../../intl.zh-CN/用户指南/Kubernetes集群/负载均衡及路由管理/通过负载均衡（Server Load Balancer）访问服务.md#)。
