...
|logService.machineGroup|如开启对阿里云日志服务的支持，则指定日志服务项目的机器组。关于阿里云日志服务的详情可参考 [使用日志服务进行Kubernetes日志采集](../../../../../intl.zh-CN/用户指南/Kubernetes集群/日志管理/使用日志服务进行Kubernetes日志采集.md#)。|
