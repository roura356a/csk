...
有关集群网络规划，请参见：[t16651.dita\#concept\_izq\_sg4\_vdb](/intl.zh-CN/Kubernetes集群用户指南/网络管理/VPC下Kubernetes集群的网络地址段规划.md)。
...
|worker\_instance\_types|Array of String|Body|是|ecs.n4.large|Worker节点实例规格，至少要指定一个实例规格。更多信息，请参见[t9548.dita\#concept\_sx4\_lxv\_tdb](/intl.zh-CN/实例/实例规格族.md)。
