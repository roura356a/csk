...
关于kritis-validation-hook组件更多信息，请参见[kritis-validation-hook组件介绍](/intl.zh-CN/Kubernetes集群用户指南/应用/镜像/kritis-validation-hook组件介绍.md)。
...
[kritis-validation-hook组件介绍](/intl.zh-CN/Kubernetes集群用户指南/应用/镜像/kritis-validation-hook组件介绍.md)
