...
关于kritis-validation-hook组件更多信息，请参见[kritis-validation-hook组件介绍](/intl.zh-CN/产品发布记录/组件介绍与变更记录/安全/kritis-validation-hook/kritis-validation-hook组件介绍.md)。
...
[kritis-validation-hook组件介绍](/intl.zh-CN/产品发布记录/组件介绍与变更记录/安全/kritis-validation-hook/kritis-validation-hook组件介绍.md)
