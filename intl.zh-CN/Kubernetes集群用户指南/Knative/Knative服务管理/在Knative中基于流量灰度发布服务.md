...
-   如果是ACK集群，关于部署Knative具体操作，请参见[部署Knative](/intl.zh-CN/Kubernetes集群用户指南/Knative/Knative组件管理/一键部署Knative.md)。
-   如果是ASK集群，关于部署Knative具体操作，请参见[开启Knative](/intl.zh-CN/Serverless Kubernetes集群用户指南/Knative/Knative组件管理/开启Knative.md)。
