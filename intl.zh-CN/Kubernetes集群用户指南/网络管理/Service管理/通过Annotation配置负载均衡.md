...
|service.beta.kubernetes.io/alibaba-cloud-loadbalancer-spec|string|负载均衡实例的规格。可参见：[CreateLoadBalancer](/intl.zh-CN/开发指南/API参考/负载均衡实例/CreateLoadBalancer.md)。|无|v1.9.3及以上版本|
