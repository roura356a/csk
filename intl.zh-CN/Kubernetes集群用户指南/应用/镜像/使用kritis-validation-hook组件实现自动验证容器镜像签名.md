...
3.  授予访问kritis-validation-hook组件所需的权限。
    ...
    如果您使用的是ACK托管版集群，还需要确保您的集群拥有运行kritis-validation-hook组件所需的访问权限。具体操作，请参见[t1876097.md\#section\_c7v\_xxm\_q88](/intl.zh-CN/Kubernetes集群用户指南/应用/镜像/kritis-validation-hook组件介绍.mdsection_c7v_xxm_q88)。
...
1.  在**证明者**页签中，单击**创建证明者**。
    ...
    创建证明者的配置信息，请参见[t1877364.md\#](/intl.zh-CN/安全运营/容器签名.md)。
...
kritis-validation-hook组件介绍，请参见[t1876097.md\#](/intl.zh-CN/Kubernetes集群用户指南/应用/镜像/kritis-validation-hook组件介绍.md)。

kritis-validation-hook组件变更记录，请参见[t1876098.md\#](/intl.zh-CN/产品发布记录/组件介绍与变更记录/安全/kritis-validation-hook.md)。
