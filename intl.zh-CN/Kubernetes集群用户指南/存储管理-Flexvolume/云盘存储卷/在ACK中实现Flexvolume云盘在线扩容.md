...
1.  [通过kubectl连接Kubernetes集群](/intl.zh-CN/Kubernetes集群用户指南/集群管理/管理与访问集群/通过kubectl连接Kubernetes集群.md)。
...
2.  在符合[使用说明](/intl.zh-CN/Kubernetes集群用户指南/存储管理-CSI/云盘存储卷/在ACK中实现CSI云盘在线扩容.md)的各个条件下，执行以下命令进行数据卷扩容。
...
1.  使用命令行工具连接Kubernetes集群，请参见[通过kubectl连接Kubernetes集群](/intl.zh-CN/Kubernetes集群用户指南/集群管理/管理与访问集群/通过kubectl连接Kubernetes集群.md)。
