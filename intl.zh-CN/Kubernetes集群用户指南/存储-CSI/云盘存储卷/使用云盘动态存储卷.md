...
1.  查看**nginx-dynamic**应用所在的Pod和云盘文件。
    ...
    1.  执行以下命令，查看**nginx-dynamic**应用所在Pod的名称。
        ...
        ```
        nginx-dynamic-****   1/1     Running     0          3m
        ```

    2.  执行以下命令，查看/data路径下是否挂载了新的云盘。

        ```
        kubectl exec nginx-dynamic-**** df | grep data
        ```
    ...
    3.  执行以下命令，查看/data路径下的文件。
        ...
        ```
        kubectl exec nginx-dynamic-**** ls /data
        ```
...
2.  在云盘里创建文件。
    ...
    1.  执行以下命令，在/data路径下创建文件dynamic。
        ...
        ```
        kubectl exec nginx-dynamic-**** touch /data/dynamic
        ```
...
4.  验证删除Pod后，云盘中创建的文件是否还存在。
    ...
    1.  执行以下命令，查看重建的Pod名称。
        ...
        nginx-dynamic-****          1/1     Running     0          2m
        ```
