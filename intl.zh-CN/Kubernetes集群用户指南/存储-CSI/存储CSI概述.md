...
更多信息，请参见[云盘存储卷使用说明](/intl.zh-CN/Kubernetes集群用户指南/存储-CSI/云盘存储卷/云盘存储卷使用说明.md)。 |
...
更多信息，请参见[NAS卷使用说明](/intl.zh-CN/Kubernetes集群用户指南/存储-CSI/NAS存储卷/NAS卷使用说明.md)。 |
...
更多信息，请参见[OSS卷使用说明](/intl.zh-CN/Kubernetes集群用户指南/存储-CSI/OSS存储卷/OSS卷使用说明.md)。 |
...
|用户自定义标签|✔️|✔️|❌|❌|✔️|✔️|✔️|
|跨主机迁移|✔️|✔️|❌|❌|✔️|✔️|✔️|
|文件存储|NFS创建，挂载，卸载|✔️|✔️|✔️|✔️|✔️|✔️|✔️|
|Samba挂载卸载|❌|❌|✔️|❌|✔️|❌|❌|
|CPFS|✔️|❌|✔️|❌|❌|❌|❌|
|NAS回收站|❌|❌|❌|❌|❌|❌|❌|
...
[云盘存储卷使用说明](/intl.zh-CN/Kubernetes集群用户指南/存储-CSI/云盘存储卷/云盘存储卷使用说明.md)

[NAS卷使用说明](/intl.zh-CN/Kubernetes集群用户指南/存储-CSI/NAS存储卷/NAS卷使用说明.md)

[OSS卷使用说明](/intl.zh-CN/Kubernetes集群用户指南/存储-CSI/OSS存储卷/OSS卷使用说明.md)
