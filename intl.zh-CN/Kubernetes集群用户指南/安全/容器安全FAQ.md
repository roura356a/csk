...
-   集群临近过期前两个月左右您会收到站内和短信通知，收到通知后在控制台集群列表页面单击证书更新按钮即可。具体操作，请参见[更新Kubernetes专有版集群即将过期的证书](/intl.zh-CN/Kubernetes集群用户指南/集群/管理集群/集群证书/更新Kubernetes专有版集群即将过期的证书.md)。
-   如果Kubernetes集群证书已过期，具体操作，请参见[更新Kubernetes集群已过期的证书](/intl.zh-CN/Kubernetes集群用户指南/集群/管理集群/集群证书/更新Kubernetes集群已过期的证书.md)。
