...
**说明：** Terway组件的NetworkPolicy功能依赖Calico CRD。若您的集群已经使用了Calico容器网络插件，开启Terway的NetworkPolicy功能时可能导致已有Calico容器网络异常。若有问题，请[提交工单](https://workorder-intl.console.aliyun.com/console.htm)咨询。
