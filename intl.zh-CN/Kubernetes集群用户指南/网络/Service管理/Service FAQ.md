...
如果您的CCM组件版本大于或等于**v1.9.3.276-g372aa98-aliyun**的话，请[提交工单](https://workorder-intl.console.aliyun.com/console.htm)。
...
5.  根据步骤3生成的KEY值和VALUE值（分别对应上图的1和2），为该SLB打上一个TAG。详情请参见[添加标签](/intl.zh-CN/传统型负载均衡CLB/CLB用户指南/实例/标签/概述.md)。
