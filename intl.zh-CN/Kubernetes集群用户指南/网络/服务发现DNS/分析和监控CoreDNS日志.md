...
1.  在目标图表卡片右上方，选择**![more](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/4484619161/p267496.png)** \> **另存为告警 \(旧版\)**。关于告警配置的参数设置，请参见[设置告警](/intl.zh-CN/可视化与告警/告警/设置告警.md)。

    创建完成告警规则后，您可以[查看告警配置](/intl.zh-CN/可视化与告警/告警/管理告警配置.md)或[查看告警记录](/intl.zh-CN/可视化与告警/告警/查看告警记录.md)。
