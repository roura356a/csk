...
2.  After the **cloud-native AI component set** is deployed, the address of AI Dashboard is displayed on the Cloud-native AI Component Set page. You can access AI Dashboard by using this address.
