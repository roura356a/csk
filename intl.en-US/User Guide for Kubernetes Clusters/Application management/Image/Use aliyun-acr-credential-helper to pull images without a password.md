...
1.  Create a RAM user for your account and grant the RAM user the permissions to pull images from Container Registry instances within your account.
    ...
    For more information about how to grant the permissions to pull images from Container Registry instances, see [Step 1](#step_ngx_6m3_ujh) in the "Pull images across accounts by assuming a RAM role" section.
