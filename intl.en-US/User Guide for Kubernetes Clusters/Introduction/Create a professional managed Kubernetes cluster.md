...
-   Each account can consume only a limited amount of computing resources. Clusters cannot be created if your computing resources are insufficient. When you create clusters, make sure that you have sufficient resources.
    -   For more information about the maximum numbers of clusters and nodes that can be created under each account, see [Quota limits on ACK](/intl.en-US/Product Introduction/Limits.md).
...
3.  In the upper-right corner of the Clusters page, click **Create Kubernetes Cluster**. In the Select Cluster Template dialog box, find Professional Managed Kubernetes Cluster and click **Create**.
...
![Resource Group](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/en-US/9688404061/p127165.png) |
        ...
        |**Kubernetes Version**|Select **1.14.8-aliyun.1** or **1.16.9-aliyun.1** for standard managed Kubernetes cluster. Pofessional managed Kubernetes clusters support only **1.16.9-aliyun.1**.|
...
8.  Read the **Terms of Service** and select the check box, and click **Create Cluster**.
