...
# Create a professional edge Kubernetes cluster \(private preview\)
...
-   Professional edge Kubernetes clusters are in private preview. To use this type of cluster, [Submit a ticket](https://workorder-intl.console.aliyun.com/console.htm) or join the DingTalk group 21976595 to contact us.
...
8.  Read **Terms of Service**, select the check box, and then click **Create Cluster**.
    ...
    **Note:** It takes about 10 minutes to create a professional edge Kubernetes cluster that contains multiple nodes.
