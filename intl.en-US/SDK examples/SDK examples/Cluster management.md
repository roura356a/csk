...
**Note:** You must install ACK SDK before you can use it to manage clusters. For more information, see [Install ACK SDK](/intl.en-US/SDK examples/Install ACK SDK.md).
...
public class Client {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 3. Query the state of an ACK cluster.
    ...
    async def main_async(
        ...
        while True:
            if UtilClient.equal_string(describe_cluster_detail_res.body.state, 'initial'):
                ...
                # Exit if the ACK cluster is in other states.
                return
        # 5. Query the state of an ACK cluster.
