...
|More available regions for Managed Kubernetes|More regions have been added to support Managed Kubernetes. Starting from June 2019, you can use Managed Kubernetes in Japan \(Tokyo\) and UK \(London\).| Japan \(Tokyo\)
 ...
 |[EN-US\_TP\_15496.md\#](reseller.en-US/Product Introduction/Alibaba Cloud Container Service for Kubernetes Overview.md#)|
...
|In-depth integration between Istio add-on and Kubernetes|Supports in-depth integration between Istio and container service Kubernetes clusters.|All|[Overview](../../../../reseller.en-US/User Guide for Kubernetes Clusters/Istio management/Overview.md#)|
...
|Istio add-on|The Istio add-on has been released.|All|[Overview](../../../../reseller.en-US/User Guide for Kubernetes Clusters/Istio management/Overview.md#)|
...
|New feature|Description|Supported regions|References|
|-----------|-----------|-----------------|----------|
|New native Kubernetes|The native Kubernetes version with the ACK v1.8.1 is supported.|All|[EN-US\_TP\_15496.md\#](reseller.en-US/Product Introduction/Alibaba Cloud Container Service for Kubernetes Overview.md#)|
