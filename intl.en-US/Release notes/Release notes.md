...
|Istio|Custom Istio Ingress and Egress gateways are supported by configuring different parameters.|All regions|[ASM](/intl.en-US/User Guide for Kubernetes Clusters/ASM.md)|
|Istio CoreDNS|Istio CoreDNS is supported. You can use the CoreDNS plug-in to read Istio service entries and associate the IP addresses of the services to their host addresses.|All regions|[ASM](/intl.en-US/User Guide for Kubernetes Clusters/ASM.md)|
