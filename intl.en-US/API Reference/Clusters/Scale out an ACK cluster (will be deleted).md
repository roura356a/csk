...
|user\_data|String|No|IyEvdXNyL2Jpbi9iYXNoCmVjaG8gIkhlbGxvIEFD\*\*\*\*|The user-defined data for nodes. For more information, see [Overview of ECS instance user data](~~49121~~). |
