 ...
 **Note:** **Note**: After a data disk is mounted, the original data that is stored on the disk is cleared. Before you mount a data disk to the nodes, we recommend that you back up the disk data.
 ...
 **Note:** **Note**: If the nodes you want to add are ENS nodes, you must set this parameter to `true`. This allows you to identify these ENS nodes. |
 ...
 **Note:** **Note**: If you specify a custom image, the custom image is used to deploy the operating systems on the system disks of the nodes. |
...
-   `none`: This policy indicates that the default CPU affinity is used. This is the default policy.
 ...
 Default value: `none`. |
|user\_data|String|No|IyEvdXNyL2Jpbi9iYXNoCmVjaG8gIkhlbGxvIEFDSyEi|The user-defined data. For more information, see [Prepare user-defined data](https://help.aliyun.com/document_detail/~~49121~~). |
